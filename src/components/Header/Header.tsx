      ...
      <div className='container'>
        <div className='flex justify-end'>
          ...
          <Popover
            ...
            renderPopover={
              <div className='bg-white relative shadow-sm border border-gray-200 rounded-sm'>
                <Link
                  to='/'
                ...
                <button className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500 text-left w-full'>
                  Đăng xuất
                </button>
              </div>
            }
