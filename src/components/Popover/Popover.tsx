import { useFloating, offset, shift, arrow, FloatingPortal, type Placement } from '@floating-ui/react-dom-interactions'
...
export default function Popover({
  ...
  const [open, setOpen] = useState(initiaOpen || false)
